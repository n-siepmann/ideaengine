...
public class Config {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/oauth2/**", "/oauth/**", "/error", "/run", "/welcome", "/about", "/goodbye", "/static/**", "/*.css", "/logo_white.svg", "/favicon*.png", "/android*.png", "/apple-touch-icon.png").permitAll()
